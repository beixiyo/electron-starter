...
export const FailureView = memo<FailureViewProps>((props) => {
  ...
  return (
    <motion.div
      ...
      className={ cn('flex size-full items-center overflow-hidden rounded-xl px-4', className) }
    >
      <div ref={ setContentRef } className="flex w-max items-center gap-3">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          { canRetry && onRetry && (
            <button
              type="button"
              className="inline-flex items-center gap-1.5 rounded-lg bg-text px-2.5 py-1.5 text-xs text-textSpecial transition-opacity hover:opacity-85 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-text3/40"
              onClick={ onRetry }
            >
