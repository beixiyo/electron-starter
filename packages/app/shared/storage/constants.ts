...
export const STORAGE_AREAS = [
  ...
  {
    id: 'native-diagnostic-log',
    owner: 'main',
    root: STORAGE_ROOTS.appHome,
    basePath: 'logs',
    path: 'logs/native-recorder.log',
    content: 'Swift audio-recorder stderr 诊断日志',
    entrypoints: [
      'main/native-diagnostic-log.ts',
      'main/audio-recorder/index.ts',
    ],
    accountScoped: false,
    logoutCleanup: false,
    sensitive: true,
    rebuildable: false,
    ttl: '超过 5 MB 时轮换为当前会话新文件',
  },
  {
