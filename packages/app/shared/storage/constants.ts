...
export const STORAGE_AREAS = [
  ...
  {
    id: 'web-diagnostic-logs-indexeddb',
    owner: 'renderer',
    root: 'browser origin',
    basePath: 'IndexedDB / AppDiagnostics / logs',
    path: 'IndexedDB / AppDiagnostics / logs',
    content: 'Web 窗口的结构化诊断日志',
    entrypoints: ['renderer/logging/webDiagnosticLogs.ts', 'renderer/services/storage/diagnosticLogDB.ts'],
    accountScoped: false,
    logoutCleanup: false,
    sensitive: true,
    rebuildable: false,
    ttl: '保留 30 天，初始化时清理过期记录',
  },
  {
